...
interface AppState {
  ...
  setSelectedVisionModel: (model: LLMModel | null) => void;
...
export const useAppStore = create<AppState>()(
  persist(
    (set) => ({
      ...
      // Custom Endpoints
      setCustomEndpoints: (customEndpoints) => set({ customEndpoints }),
      ...
      // UI State
      setIsLoading: (isLoading, loadingMessage = '') => set({ isLoading, loadingMessage }),
